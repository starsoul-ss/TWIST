...
class L3MimicCfg(HumanoidMimicCfg):
    class env(HumanoidMimicCfg.env):
        ...
        n_proprio = len(tar_obs_steps) * n_mimic_obs + 3 + 2 + 3*num_actions
    ...
    class asset(HumanoidMimicCfg.asset):
        file = '{LEGGED_GYM_ROOT_DIR}/../assets/l3/l3_29dof_neck_fixed.urdf'
        
        # for both joint and link name
        torso_name: str = 'pelvis'  # humanoid pelvis part
        chest_name: str = 'imu_in_torso'  # humanoid chest part #TODO
    ...
    class rewards(HumanoidMimicCfg.rewards):
        ...
        class scales:
            tracking_joint_dof = 1.0
            tracking_joint_vel = 0.2
            tracking_root_pose = 0.6
            tracking_root_vel = 0.4
            tracking_keybody_pos = 0.7
...
class L3MimicCfgPPO(HumanoidMimicCfgPPO):
    seed = 1
